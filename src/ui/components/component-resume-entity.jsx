        ...
        <div className={"row"}>
            ...
            <div className="col-6">
                <div className="d-flex justify-content-end gap-2">
                    <div className={"border rounded-3 text-end px-5 py-3 position-relative bg-warning-subtle border-warning-subtle"}>
                        <KTIcon name={"time"}
                    ...
                    <div className={"border rounded-3 text-end position-relative px-5 py-3 bg-success-subtle border-success-subtle"}>
